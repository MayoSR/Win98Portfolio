...
export default function ProgrammingLanguageAnalysis() {
    return (
        <div>
            <p className=" font-bold text-5xl p-12 text-justify">Programming language analysis and teammate recommender using Social Networks from Stackoverflow data</p>
            <div className='flex p-12'>
                <div className='text-justify flex-[0.5]'>
                    
                    <div>
                        <p className=" font-bold text-2xl mb-2">About</p>
                        <p className=" font-bold text-2xl mb-4">This was a multi faceted project which consisted of two parts. 
                        </p>
                        <p className="text-black text-3xl mb-2">Part 1 : Programming language recommender</p>
                        ...
                        <p className="text-black text-3xl mb-2">Part 2 : Teammate recommender</p>
                        <p className="text-lg mb-2">
                ...
                <div className="h-[100vh] p-8 flex-[0.5]">
